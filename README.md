...
Run up an SSH container named 'ssh.1' from the docker image 'pdouble16/fedora-ssh' on port 2020 of your docker host.
...
Run up an SFTP container named 'sftp.1' from the docker image 'pdouble16/fedora-ssh' on port 2021 of your docker host.
...
```
$ docker run --rm pdouble16/fedora-ssh \
